...
- Historical data based selected time range
- Service dropdown added for alert table and it is persistence with URL state.
- Prepend live stream alerts with highlight animation on alert table.